...
// TODO: test
export class GetAllSubdomainsForDomainUseCase extends UseCase<GetAllSubdomainsForDomainRequestEntity, GetAllSubdomainsForDomainResponseEntity> {
   ...
   */
  protected useCaseLogic(): Promise<GetAllSubdomainsForDomainResponseEntity | ErrorResponseEntity> {
