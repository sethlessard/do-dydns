...
@injectable()
export class ResetDigitalOceanApiKey extends UseCase<
  void,
  ResetDigitalOceanApiResponseEntity
> {
  /**
   * Create a new ResetDigitalOceanApiKey instance.
  ...
  protected useCaseLogic(): Promise<
    ErrorResponseEntity | ResetDigitalOceanApiResponseEntity
  > {
