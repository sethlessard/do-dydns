...
export class GetAllLogsUseCase extends UseCase<undefined, GetAllLogsResponseEntity> {
   ...
   */
  protected useCaseLogic(): Promise<GetAllLogsResponseEntity | ErrorResponseEntity> {
